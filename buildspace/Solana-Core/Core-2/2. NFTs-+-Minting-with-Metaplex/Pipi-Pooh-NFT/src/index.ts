...
const tokenName = "Pooh Bear"
const description = "Pooh Bear by Pipi"
const symbol = "POOH"
const sellerFeeBasisPoints = 100
const imageFile = "Pooh_Bear_New.jpg"
...
async function main() {
  ...
  const mintAddress = new PublicKey("7RiVRujrBnvQvwBwxyo3aMiiGWk5ruUabymVwNmiJVLu")
